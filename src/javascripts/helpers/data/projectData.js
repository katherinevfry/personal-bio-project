const projects = [
  {
    title: 'Tamagucci',
    screenshot: 'https://github.com/katherinevfry/photo-area/blob/main/2.png?raw=true',
    description: 'Tamagucci is for anyone who wants to relive the glory days of the 90s and attempt to keep a digital pet alive! The user can train their pet to eat, play, train, and sleep! The user interface is a callback to the fun colors and lofi gradients of the 90s.', // A good project description includes 'the what', 'the why', and 'the how'.
    technologiesUsed:
      'HTML, SCSS, Vanilla JavaScript, Bootstrap, Webpack, Version Control with Github',
    available: true,
    url: 'https://kf-tamagotchi.netlify.app/',
    githubUrl: 'https://github.com/katherinevfry/ASSIGNMENT-Tamagotchi',
  },
